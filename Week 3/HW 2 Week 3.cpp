// HW 2 Week 3.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
char get_user_input() 
{
	char letter;  //declaring a character variable
	cin >> letter;
	return letter;
...
void to_upper_case(char &letter)
{
	...
	if (letter == 'A') // If it the input is true, then it returns A cout statement.
	{
		user_input_letter == 'A';
	}
	if (letter == 'B')
